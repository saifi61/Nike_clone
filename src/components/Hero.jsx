  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        <p
          className="text-lg font-monsterrat text-coral-red"
        ...
        <p
          className="font-monsterrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm"
        ...
        <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((stats, index) => (
            <div key={index}>
              ...
              >{stats.value}</p>
              <p
                className="leading-7 font-monsterrat text-slate-gray"
              >{stats.label}</p>
            </div>
          ))}
        </div>
      ...
      <div
        className="relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primery bg-hero bg-cover bg-center"
      >
        <img 
          src={bigShoeImage}
          alt="shoe collection"
